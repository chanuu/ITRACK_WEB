...
{
    public class EventRegistrationPolicy : ITRACKServiceBase, IEventRegistrationPolicy
    {
        ...
        private async Task CheckEventRegistrationFrequencyAsync(User user)
        {
            ...
            var maxAllowedEventRegistrationCountInLast30DaysPerUser = await SettingManager.GetSettingValueAsync<int>(ITRACKSettingNames.MaxAllowedEventRegistrationCountInLast30DaysPerUser);
