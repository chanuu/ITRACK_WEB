...
using ITRACK.Events;
using ITRACK.Events.Dtos;
using ITRACK.Tests.Data;
using ITRACK.Tests.Sessions;
using NSubstitute;
using Shouldly;
using Xunit;

namespace ITRACK.Tests.Events
{
    public class EventAppService_Tests : ITRACKTestBase
    {
        ...
        private static Event GetTestEvent(ITRACKDbContext context)
        {
